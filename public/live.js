(function() {
  ...
  const _WD_SVGS = {
    ...
    foot:   '<circle fill="currentColor" cx="12" cy="4.5" r="2.5"/><path fill="currentColor" d="M12.528 10.753a4.315 4.315 0 0 0-.258-.003h-1.091l-.091.912c-.174 1.74-.235 2.44-.08 3.101.156.662.522 1.261 1.453 2.742l2.575 4.096a.75.75 0 0 1-1.27.798l-2.575-4.096-.073-.116c-.835-1.327-1.35-2.146-1.56-3.046-.21-.9-.15-1.793.028-3.61l.127-1.275a3.75 3.75 0 0 1 2.81-3.321l1.673-.42a3.75 3.75 0 0 1 3.562 1.003l1.84 1.84a.75.75 0 1 1-1.06 1.06l-1.84-1.839a2.25 2.25 0 0 0-2.084-.631l.8 1.032z"/>',
    moto:   '<path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M13.864 5.783c-.313-.032-.72-.033-1.336-.033H12a.75.75 0 0 1 0-1.5h.565c.57 0 1.054 0 1.454.041.425.044.819.14 1.19.37.373.23.634.539.864.9.202.318.405.72.64 1.189h1.155c.284 0 .545 0 .762.02.235.02.466.065.691.185.225.12.392.29.525.483.12.175.217.393.328.642l1.3 2.9H22a.75.75 0 0 1 0 1.5h-1.75v1.25A3.25 3.25 0 1 1 14.1 12H9.9a3.25 3.25 0 1 1-5.988 1.75H2a.75.75 0 0 1 0-1.5h2.25V11h-.002c.15-1.654.496-2.746 1.253-3.503C6.39 6.61 7.612 6.28 9.5 6.25h2.614c.08-.283.14-.479.21-.661.116-.303.263-.556.517-.722.253-.166.534-.212.797-.233.234-.019.508-.022.226-.05zM6.5 16.5a1.75 1.75 0 1 0 0-3.5 1.75 1.75 0 0 0 0 3.5zm11 0a1.75 1.75 0 1 0 0-3.5 1.75 1.75 0 0 0 0 3.5z"/>',
    truck:  '<path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M2.75 6a.75.75 0 0 0-1.5 0v12a.75.75 0 0 0 1.5 0v-1.25h18.392V18a.75.75 0 0 0 1.5 0v-2.357c0-1.995 0-2.992-.28-3.794a5 5 0 0 0-3.068-3.068c-.802-.28-1.8-.28-3.794-.28h-.002c-.798 0-1.838 0-2.159.111a2.002 2.002 0 0 0-1.187 1.12c-.16.41-.16.94-.16 1.517v1.5H2.75V6zm11.5 8.25V12.4c0-.484.006-.618.027-.675a.5.5 0 0 1 .296-.28c.055-.02.185-.027.677-.027h.002c2.14 0 2.954.015 3.554.214a3.5 3.5 0 0 1 2.148 2.148c.199.6.214 1.414.214 3.554H14.25v-.084z"/><circle fill="currentColor" cx="6.5" cy="19.5" r="1.75"/><circle fill="currentColor" cx="17" cy="19.5" r="1.75"/>',
    bus:    '<path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M12 2C8.229 2 6.343 2 5.172 3.172 4.108 4.235 4.01 5.886 4 9H3a1 1 0 0 0-1 1v1a1 1 0 0 0 .4.8L4 13c.01 3.114.108 4.765 1.172 5.828.242.243.514.435.828.587V21a1 1 0 0 0 1 1h1.5a1 1 0 0 0 1-1v-1.018C10.227 20 11.054 20 12 20s1.773 0 2.5.018V21a1 1 0 0 0 1 1H17a1 1 0 0 0 1-1v-1.585c.314-.152.586-.344.828-.587C19.892 17.765 19.99 16.114 20 13l1.6-1.2A1 1 0 0 0 22 11v-1a1 1 0 0 0-1-1h-1c-.01-3.114-.108-4.765-1.172-5.828C17.657 2 15.771 2 12 2zM8.5 16a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm7 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM8 9V6h8v3H8z"/>',
    train:  '<path fill="currentColor" d="M20 12.25V10c0-3.771 0-5.657-1.172-6.828-.878-.88-2.16-1.099-4.336-1.154A.48.48 0 0 0 14 2.5a2 2 0 1 1-4 0 .48.48 0 0 0-.492-.482c-2.177.055-3.458.275-4.336 1.154C4 4.343 4 6.229 4 10v2.25h16z"/><path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M6.376 19.572c-.478-.17-.87-.41-1.204-.744-.975-.974-1.139-2.442-1.166-5.078h15.988c-.027 2.636-.191 4.104-1.166 5.078a3.153 3.153 0 0 1-1.203.744l1.046 2.093a.75.75 0 0 1-1.342.67l-1.224-2.447C15.057 20 13.587 20 12 20s-3.057 0-4.105.168L6.671 22.615a.75.75 0 0 1-1.341-.671l1.046-2.372zM9.25 17a.75.75 0 0 1 .75-.75h4a.75.75 0 0 1 0 1.5h-4a.75.75 0 0 1-.75-.75z"/>',
    scooter:'<path fill="currentColor" d="M10 2H9c-2.828 0-4.243 0-5.121.879C3 3.757 3 5.172 3 8v13.25H2a.75.75 0 0 0 0 1.5h15.25a.75.75 0 0 0 0-1.5H16v-3.5h1.571c.375 0 .679.304.679.679v.071a2.25 2.25 0 1 0 4.5 0V7.602c0-.157 0-.265-.006-.37a2.25 2.25 0 0 0-2.247-2.232H16.5v-.25C16.5 3.172 15.086 2 12.257 2H10z"/>',
    dog:    '<path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M10.47 2.235a.75.75 0 0 1 .53-.235H13a3 3 0 0 1 3 3 3 3 0 0 1 3 3v1.5a.75.75 0 0 1-.75.75H17.5v7.845A2.625 2.625 0 1 1 13 18.5V15h-2v3.5a2.625 2.625 0 1 1-4.5.345V9.75H5.75A.75.75 0 0 1 5 9V7.5a3 3 0 0 1 2.757-2.99 3.002 3.002 0 0 1 2.493-2.49l.22-.785z"/>',
  ...
  const _WD_ALIASES = {
    ...
    boat:'boat', kayak:'boat', canoe:'boat', sail:'boat',
    bus:'bus', transit:'bus',
    train:'train', rail:'train', tram:'train',
